...
class CustomerSearchActivity : AppCompatActivity() {
    ...
    private var customerListFragment: CustomerListFragment? = null
    ...
    private inner class ViewPagerAdapter(activity: AppCompatActivity) : FragmentStateAdapter(activity) {
        ...
        override fun createFragment(position: Int): CustomerListFragment {
            val fragment = CustomerListFragment()
            customerListFragment = fragment
            return fragment
        }
    }
    ...
    private fun performSearch(query: String) {
        val resultList = customerDao.findCustomersByName(query)
        customerListFragment?.updateCustomerList(resultList)
    }
